...
| <a name="input_deployment_circuit_breaker"></a> [deployment\_circuit\_breaker](#input\_deployment\_circuit\_breaker) | Deployment circuit breaker configuration for safer deployments | <pre>object({<br/>    enable   = optional(bool, true)<br/>    rollback = optional(bool, true)<br/>  })</pre> | <pre>{<br/>  "enable": true,<br/>  "rollback": true<br/>}</pre> | no |
