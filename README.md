...
| <a name="input_ecr_repositories_arns"></a> [ecr\_repositories\_arns](#input\_ecr\_repositories\_arns) | List of ECR repository ARNs for the task execution role | `list(string)` | n/a | yes |
...
| <a name="output_ecs_ci_iam_role_arn"></a> [ecs\_ci\_iam\_role\_arn](#output\_ecs\_ci\_iam\_role\_arn) | ARN of the ECS CI/CD IAM role |
| <a name="output_ecs_ci_iam_role_name"></a> [ecs\_ci\_iam\_role\_name](#output\_ecs\_ci\_iam\_role\_name) | Name of the ECS CI/CD IAM role |
